    ...
    <div class="relative flex bg-white mb-4 pb-1" :id="group.key">
        <div class="z-10 bg-white border-t border-l border-b border-60 h-auto pin-l pin-t rounded-l self-start w-8">
            <button
                ...
                v-if="collapsed">
                <icon class="align-top inline-block" type="plus-square" width="16" height="16" view-box="0 0 24 24" />
            </button>
            <div v-if="!collapsed">
                <button
                    dusk="collapse-group"
                    ...
                    <icon class="align-top inline-block" type="minus-square" width="16" height="16" view-box="0 0 24 24" />
                </button>
                <div v-if="!readonly">
                    <button
                        dusk="move-up-group"
                        ...
                        <icon class="inline-block" type="arrow-up" view-box="0 0 8 4.8" width="10" height="10" />
                    </button>
                    <button
                        ...
                        <icon class="inline-block" type="arrow-down" view-box="0 0 8 4.8" width="10" height="10" />
                    </button>
                    <button
                        dusk="delete-group"
                        type="button"
                        ...
                        <icon class="inline-block" type="delete" view-box="0 0 20 20" width="16" height="16" />
                    </button>
                    <portal to="modals">
